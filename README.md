...
```
variableGroups: 
    - coreai-techspike-document-analysis-snd1
    - coreai-techspike-document-analysis-snd2
    - coreai-techspike-document-analysis-snd3
variables:
    - coreai-techspike-document-analysis-APPINSIGHTS-CONNECTIONSTRING
```
